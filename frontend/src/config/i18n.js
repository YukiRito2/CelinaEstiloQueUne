  ...
  es: {
    ...
    services: {
      ...
      cards: [
        ...
        {
          id: "fiber",
          title: "Fibra óptica y línea móvil para tu negocio",
          text: "Te ayudamos a contratar la fibra óptica y la línea móvil que tu empresa necesita, de la mano de Nasertel: conexión rápida y estable, más tarifas móviles a tu medida.",
          cta: "Quiero información",
          chips: ["FIBRA ÓPTICA", "LÍNEA MÓVIL", "SIMYO", "MASMÓVIL", "JAZZTEL", "PEPEPHONE"],
        },
      ],
    },
    money: {
    ...
    fiberPage: {
      ...
      overline: "Fibra óptica y móvil · Empresas",
      title: "Lleva tu negocio a la velocidad real",
      subtitle:
        "Conecta tu empresa con la fibra óptica más rápida, estable y segura del mercado, y contrata tu línea móvil, todo de la mano de Nasertel, especialistas en telecomunicaciones desde 2011.",
  ...
  ca: {
    ...
    services: {
      ...
      cards: [
        ...
        {
          id: "fiber",
          title: "Fibra òptica i línia mòbil per al teu negoci",
          text: "T'ajudem a contractar la fibra òptica i la línia mòbil que la teva empresa necessita, de la mà de Nasertel: connexió ràpida i estable, més tarifes mòbils a la teva mida.",
          cta: "Vull informació",
          chips: ["FIBRA ÒPTICA", "LÍNIA MÒBIL", "SIMYO", "MASMÓVIL", "JAZZTEL", "PEPEPHONE"],
        },
      ],
    },
    money: {
    ...
    fiberPage: {
      ...
      overline: "Fibra òptica i mòbil · Empreses",
      title: "Porta el teu negoci a la velocitat real",
      subtitle:
        "Connecta la teva empresa amb la fibra òptica més ràpida, estable i segura del mercat, i contracta la teva línia mòbil, tot de la mà de Nasertel, especialistes en telecomunicacions des del 2011.",
  ...
  en: {
    ...
    services: {
      ...
      cards: [
        ...
        {
          id: "fiber",
          title: "Fiber internet & mobile for your business",
          text: "We help you set up the fiber optic and mobile line your business needs, together with Nasertel: fast, stable connection plus mobile plans made to measure.",
          cta: "I want info",
          chips: ["FIBER OPTIC", "MOBILE LINE", "SIMYO", "MASMÓVIL", "JAZZTEL", "PEPEPHONE"],
        },
      ],
    },
    money: {
    ...
    fiberPage: {
      ...
      overline: "Fiber & mobile · Business",
      title: "Take your business up to real speed",
      subtitle:
        "Connect your business with the fastest, most stable and secure fiber optic on the market, and set up your mobile line, all together with Nasertel, telecom specialists since 2011.",
