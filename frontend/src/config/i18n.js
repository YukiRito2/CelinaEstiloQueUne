  ...
  es: {
    ...
    services: {
      ...
      cards: [
        ...
        {
          id: "fiber",
          title: "Línea móvil y fibra óptica para tu negocio",
          text: "Te ayudamos a contratar la línea móvil y la fibra óptica que tu empresa necesita, de la mano de Nasertel: tarifas móviles a tu medida, más conexión rápida y estable.",
          cta: "Quiero información",
          chips: ["LÍNEA MÓVIL", "SIMYO", "MASMÓVIL", "JAZZTEL", "PEPEPHONE", "FIBRA ÓPTICA"],
        },
      ],
    },
    money: {
    ...
    fiberPage: {
      ...
      title: "Lleva tu negocio a la velocidad real",
      subtitle:
        "Contrata tu línea móvil y conecta tu empresa con la fibra óptica más rápida, estable y segura del mercado, todo de la mano de Nasertel, especialistas en telecomunicaciones desde 2011.",
      ctaLabel: "Quiero información sobre fibra",
      ctaHint:
        "Sin compromiso: primero entendemos qué necesita tu empresa y Nasertel se encarga de la contratación.",
      whatsappLabel: "O pregunta por WhatsApp",
      faqTitle: "Preguntas frecuentes",
      featuresTitle: "Por qué elegir fibra óptica",
      features: [
        { title: "Velocidad simétrica", text: "Misma velocidad de subida y bajada: ideal para videollamadas, la nube y el envío de archivos grandes." },
        { title: "Estable y segura", text: "Transmite datos mediante luz, no electricidad, lo que evita interferencias y cortes." },
        { title: "Sin límite de dispositivos", text: "Soporta múltiples conexiones a la vez sin perder rendimiento — perfecta para equipos y coworkings." },
      ],
      faq: [
        { question: "¿Por qué elegir fibra óptica para mi empresa?", answer: "Porque es la conexión más rápida, estable y segura del mercado. Ideal para negocios que dependen del entorno digital." },
        { question: "¿Qué diferencia hay con el ADSL?", answer: "La fibra óptica transmite datos a mayor velocidad y menor latencia. Además es simétrica: misma velocidad de subida y bajada." },
        { question: "¿Mi empresa necesita realmente tanta velocidad?", answer: "Sí, si haces videollamadas, usas la nube, envías archivos grandes o trabajas en remoto. Tu productividad depende de una conexión ágil." },
        { question: "¿Qué pasa si tengo muchos dispositivos conectados?", answer: "La fibra óptica soporta múltiples dispositivos sin pérdida de rendimiento — perfecta para entornos colaborativos." },
        { question: "¿También puedo contratar línea móvil con vosotros?", answer: "Sí, junto con la fibra gestionamos también líneas móviles de Simyo, MasMóvil, Jazztel y Pepephone, para tu empresa o a nivel particular." },
      ],
      facts: [
        "La fibra óptica transmite datos mediante luz, no electricidad, lo que evita interferencias.",
        "Cada vez más coworkings y oficinas remotas la adoptan como estándar.",
        "Las empresas con buena conexión a internet llegan a ser hasta un 30% más productivas digitalmente.",
      ],
      mobile: {
        title: "Líneas móviles para tu empresa (y para ti)",
        text: "Además de fibra, con Nasertel gestionamos también tu línea móvil. Trabajamos con Simyo, MasMóvil, Jazztel y Pepephone para que elijas la tarifa que mejor se adapte a tu negocio o a tu día a día.",
        points: [
          "Portabilidad sin cortes ni perder tu número",
          "Tarifas para autónomos y empresas, también líneas adicionales para tu equipo",
          "Te asesoramos para elegir la compañía y tarifa que más te conviene",
        ],
        simNote: "Recoge tu SIM física en nuestra tienda — ven cuando quieras, te la damos al momento.",
        ctaLabel: "Quiero información sobre línea móvil",
        whatsappLabel: "Consultar por WhatsApp",
      },
      factsTitle: "¿Sabías que...?",
      partnerTitle: "Trabajamos con Nasertel",
      partnerText: "Especialistas en telecomunicaciones desde 2011.",
      partnerLink: "Visitar nasertel.es",
      ...
      tariffs: {
        ...
        groupNotes: {
          mobile: "Solo línea móvil, sin fibra — ideal si ya tienes internet en casa.",
          fibraMobile: "Fibra para casa y línea móvil juntas, en una sola factura.",
          fibra: "Solo fibra para tu vivienda, sin línea móvil.",
          additional: "Súmale una línea móvil más a tu tarifa de fibra, para tu equipo o tu familia.",
          secondHome: "Fibra para una segunda vivienda, a un precio más ajustado.",
          tv: "Añade canales y plataformas de streaming a tu fibra.",
        },
        itemNotes: {
          jazztelDisney: "Más de 90 canales + todo el catálogo de Disney+.",
          jazztelNetflix: "Más de 90 canales + todo el catálogo de Netflix.",
          jazztelPrimeHbo: "Más de 90 canales + Prime Video y HBO Max.",
          orangeTvLibre: "Fútbol (LaLiga y Champions League) y más de 90 canales.",
          jazztelFinalPrice: "Precio definitivo: no sube con el tiempo.",
        },
        ...
        footnotes: {
          ...
          limitedOffer: "Oferta válida hasta el 04/10/2026 · llamadas ilimitadas incluidas y sin permanencia.",
          upgrade1gb: "Sube a Fibra 1Gb en cualquier tarifa por +8€/mes.",
          callsAddon: "Añade llamadas ilimitadas fijo + móvil por +3€/mes.",
          simyoAddonCondition: "Precio reducido si ya tienes una línea principal de fibra + móvil de contrato desde 8,5€/mes.",
        },
        disclaimer:
          "Precios con IVA incluido, orientativos y sujetos a las condiciones vigentes de cada operador (Simyo, Jazztel) — consulta las condiciones legales completas en simyo.es o jazztel.es. Te confirmamos la tarifa y condiciones exactas antes de contratar.",
      },
    },
    pagesSeo: {
      services: {
  ...
  ca: {
    ...
    services: {
      ...
      cards: [
        ...
        {
          id: "fiber",
          title: "Línia mòbil i fibra òptica per al teu negoci",
          text: "T'ajudem a contractar la línia mòbil i la fibra òptica que la teva empresa necessita, de la mà de Nasertel: tarifes mòbils a la teva mida, més connexió ràpida i estable.",
          cta: "Vull informació",
          chips: ["LÍNIA MÒBIL", "SIMYO", "MASMÓVIL", "JAZZTEL", "PEPEPHONE", "FIBRA ÒPTICA"],
        },
      ],
    },
    money: {
    ...
    documentsPage: {
      ...
      priceOver: "Des de",
      priceSub: "5€",
      ctaLabel: "Emplenar el formulari",
    ...
    fiberPage: {
      ...
      title: "Porta el teu negoci a la velocitat real",
      subtitle:
        "Contracta la teva línia mòbil i connecta la teva empresa amb la fibra òptica més ràpida, estable i segura del mercat, tot de la mà de Nasertel, especialistes en telecomunicacions des del 2011.",
      ctaLabel: "Vull informació sobre fibra",
      ctaHint:
        "Sense compromís: primer entenem què necessita la teva empresa i Nasertel s'encarrega de la contractació.",
      whatsappLabel: "O pregunta per WhatsApp",
      faqTitle: "Preguntes freqüents",
      featuresTitle: "Per què triar fibra òptica",
      features: [
        { title: "Velocitat simètrica", text: "Mateixa velocitat de pujada i baixada: ideal per a videotrucades, el núvol i l'enviament d'arxius grans." },
        { title: "Estable i segura", text: "Transmet dades mitjançant llum, no electricitat, cosa que evita interferències i talls." },
        { title: "Sense límit de dispositius", text: "Suporta múltiples connexions alhora sense perdre rendiment — perfecta per a equips i coworkings." },
      ],
      faq: [
        { question: "Per què triar fibra òptica per a la meva empresa?", answer: "Perquè és la connexió més ràpida, estable i segura del mercat. Ideal per a negocis que depenen de l'entorn digital." },
        { question: "Quina diferència hi ha amb l'ADSL?", answer: "La fibra òptica transmet dades a més velocitat i menys latència. A més és simètrica: mateixa velocitat de pujada i baixada." },
        { question: "La meva empresa necessita realment tanta velocitat?", answer: "Sí, si fas videotrucades, uses el núvol, envies arxius grans o treballes en remot. La teva productivitat depèn d'una connexió àgil." },
        { question: "Què passa si tinc molts dispositius connectats?", answer: "La fibra òptica suporta múltiples dispositius sense pèrdua de rendiment — perfecta per a entorns col·laboratius." },
        { question: "També puc contractar línia mòbil amb vosaltres?", answer: "Sí, juntament amb la fibra gestionem també línies mòbils de Simyo, MasMóvil, Jazztel i Pepephone, per a la teva empresa o a nivell particular." },
      ],
      facts: [
        "La fibra òptica transmet dades mitjançant llum, no electricitat, cosa que evita interferències.",
        "Cada cop més coworkings i oficines remotes l'adopten com a estàndard.",
        "Les empreses amb bona connexió a internet arriben a ser fins a un 30% més productives digitalment.",
      ],
      mobile: {
        title: "Línies mòbils per a la teva empresa (i per a tu)",
        text: "A més de fibra, amb Nasertel gestionem també la teva línia mòbil. Treballem amb Simyo, MasMóvil, Jazztel i Pepephone perquè triïs la tarifa que millor s'adapti al teu negoci o al teu dia a dia.",
        points: [
          "Portabilitat sense talls ni perdre el teu número",
          "Tarifes per a autònoms i empreses, també línies addicionals per al teu equip",
          "T'assessorem per triar la companyia i tarifa que més et convé",
        ],
        simNote: "Recull la teva SIM física a la nostra botiga — vine quan vulguis, te la donem al moment.",
        ctaLabel: "Vull informació sobre línia mòbil",
        whatsappLabel: "Consultar per WhatsApp",
      },
      factsTitle: "Sabies que...?",
      partnerTitle: "Treballem amb Nasertel",
      partnerText: "Especialistes en telecomunicacions des del 2011.",
      partnerLink: "Visitar nasertel.es",
      operators: ["Simyo", "MasMóvil", "Jazztel", "Pepephone"],
      ...
      tariffs: {
        ...
        groupNotes: {
          mobile: "Només línia mòbil, sense fibra — ideal si ja tens internet a casa.",
          fibraMobile: "Fibra per a casa i línia mòbil juntes, en una sola factura.",
          fibra: "Només fibra per al teu habitatge, sense línia mòbil.",
          additional: "Suma-hi una línia mòbil més a la teva tarifa de fibra, per al teu equip o la teva família.",
          secondHome: "Fibra per a una segona residència, a un preu més ajustat.",
          tv: "Afegeix canals i plataformes d'streaming a la teva fibra.",
        },
        itemNotes: {
          jazztelDisney: "Més de 90 canals + tot el catàleg de Disney+.",
          jazztelNetflix: "Més de 90 canals + tot el catàleg de Netflix.",
          jazztelPrimeHbo: "Més de 90 canals + Prime Video i HBO Max.",
          orangeTvLibre: "Futbol (LaLiga i Champions League) i més de 90 canals.",
          jazztelFinalPrice: "Preu definitiu: no puja amb el temps.",
        },
        ...
        footnotes: {
          ...
          limitedOffer: "Oferta vàlida fins al 04/10/2026 · trucades il·limitades incloses i sense permanència.",
          upgrade1gb: "Puja a Fibra 1Gb en qualsevol tarifa per +8€/mes.",
          callsAddon: "Afegeix trucades il·limitades fix + mòbil per +3€/mes.",
          simyoAddonCondition: "Preu reduït si ja tens una línia principal de fibra + mòbil de contracte des de 8,5€/mes.",
        },
        disclaimer:
          "Preus amb IVA inclòs, orientatius i subjectes a les condicions vigents de cada operador (Simyo, Jazztel) — consulta les condicions legals completes a simyo.es o jazztel.es. Et confirmem la tarifa i condicions exactes abans de contractar.",
      },
    },
    pagesSeo: {
      services: {
    ...
    messages: {
      ...
      fiber: "Hola, vull informació sobre fibra òptica per a la meva empresa.",
      mobile: "Hola, vull informació sobre línies de telefonia mòbil.",
    },
  },
  ...
  en: {
    ...
    services: {
      ...
      cards: [
        ...
        {
          id: "fiber",
          title: "Mobile & fiber internet for your business",
          text: "We help you set up the mobile line and fiber optic your business needs, together with Nasertel: mobile plans made to measure, plus a fast, stable connection.",
          cta: "I want info",
          chips: ["MOBILE LINE", "SIMYO", "MASMÓVIL", "JAZZTEL", "PEPEPHONE", "FIBER OPTIC"],
        },
      ],
    },
    money: {
    ...
    fiberPage: {
      seoTitle: "Fiber Internet & Mobile for Business | Celina, La Seu d'Urgell",
      seoDesc:
        "Get fiber optic internet and mobile lines (Simyo, MasMóvil, Jazztel and Pepephone) for your business in La Seu d'Urgell, together with Nasertel. Fast, stable and secure connection.",
      overline: "Mobile & fiber · Business",
      title: "Take your business up to real speed",
      subtitle:
        "Set up your mobile line and connect your business with the fastest, most stable and secure fiber optic on the market, all together with Nasertel, telecom specialists since 2011.",
      ctaLabel: "I want info about fiber",
      ctaHint:
        "No obligation: first we understand what your business needs and Nasertel handles the contract.",
      whatsappLabel: "Or ask on WhatsApp",
      faqTitle: "Frequently asked questions",
      featuresTitle: "Why choose fiber optic",
      features: [
        { title: "Symmetric speed", text: "Same upload and download speed: ideal for video calls, the cloud and sending large files." },
        { title: "Stable and secure", text: "It transmits data through light, not electricity, avoiding interference and outages." },
        { title: "No device limit", text: "It supports many connections at once without losing performance — perfect for teams and coworkings." },
      ],
      faq: [
        { question: "Why choose fiber optic for my business?", answer: "Because it's the fastest, most stable and secure connection on the market. Ideal for businesses that rely on the digital world." },
        { question: "What's the difference with ADSL?", answer: "Fiber optic transmits data at higher speed and lower latency. It's also symmetric: same upload and download speed." },
        { question: "Does my business really need that much speed?", answer: "Yes, if you make video calls, use the cloud, send large files or work remotely. Your productivity depends on a fast connection." },
        { question: "What if I have many connected devices?", answer: "Fiber optic supports multiple devices with no drop in performance — perfect for collaborative environments." },
        { question: "Can I also set up a mobile line with you?", answer: "Yes, along with fiber we also manage mobile lines from Simyo, MasMóvil, Jazztel and Pepephone, for your business or as an individual." },
      ],
      facts: [
        "Fiber optic transmits data through light, not electricity, which avoids interference.",
        "More and more coworkings and remote offices adopt it as standard.",
        "Businesses with a good internet connection can be up to 30% more productive digitally.",
      ],
      mobile: {
        title: "Mobile lines for your business (and for you)",
        text: "Besides fiber, with Nasertel we also manage your mobile line. We work with Simyo, MasMóvil, Jazztel and Pepephone so you can pick the plan that best fits your business or your daily life.",
        points: [
          "Number portability with no downtime and keeping your number",
          "Plans for freelancers and companies, plus extra lines for your team",
          "We advise you on the best provider and plan for you",
        ],
        simNote: "Pick up your physical SIM at our store — come by any time, we hand it to you on the spot.",
        ctaLabel: "I want info about a mobile line",
        whatsappLabel: "Ask on WhatsApp",
      },
      factsTitle: "Did you know...?",
      partnerTitle: "We work with Nasertel",
      partnerText: "Telecom specialists since 2011.",
      partnerLink: "Visit nasertel.es",
      operators: ["Simyo", "MasMóvil", "Jazztel", "Pepephone"],
      ...
      tariffs: {
        ...
        groupNotes: {
          mobile: "Mobile line only, no fiber — ideal if you already have internet at home.",
          fibraMobile: "Home fiber and a mobile line together, on one bill.",
          fibra: "Fiber only for your home, no mobile line.",
          additional: "Add one more mobile line to your fiber plan, for your team or your family.",
          secondHome: "Fiber for a second home, at a lower price.",
          tv: "Add channels and streaming platforms to your fiber.",
        },
        itemNotes: {
          jazztelDisney: "90+ channels + the full Disney+ catalog.",
          jazztelNetflix: "90+ channels + the full Netflix catalog.",
          jazztelPrimeHbo: "90+ channels + Prime Video and HBO Max.",
          orangeTvLibre: "Football (LaLiga and Champions League) and 90+ channels.",
          jazztelFinalPrice: "Final price — it won't go up over time.",
        },
        ...
        footnotes: {
          ...
          limitedOffer: "Offer valid until 04/10/2026 · unlimited calls included, no lock-in.",
          upgrade1gb: "Upgrade to Fiber 1Gb on any plan for +€8/mo.",
          callsAddon: "Add unlimited landline + mobile calls for +€3/mo.",
          simyoAddonCondition: "Reduced price if you already have a main fiber + mobile contract line from €8.50/mo.",
        },
        disclaimer:
          "Prices include VAT, indicative and subject to each operator's current terms (Simyo, Jazztel) — see the full legal terms at simyo.es or jazztel.es. We'll confirm the exact plan and terms before you sign up.",
      },
    },
    pagesSeo: {
      services: {
    ...
    messages: {
      ...
      fiber: "Hi, I'd like information about fiber optic internet for my business.",
      mobile: "Hi, I'd like information about mobile phone lines.",
    },
  },
};
